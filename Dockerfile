...
RUN echo "[bust=193]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@98bcdde \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @98bcdde (upstream main — PR #237 买入 amount_precision 取整预检 + 台账记实际成交 filled, bust=193) + vibe-trading @v0.1.12"
