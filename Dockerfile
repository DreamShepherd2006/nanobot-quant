...
RUN echo "[bust=46]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@3c92e35 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @3c92e35 (CD fork feat/wallet-balance-all — VERIFY ONLY: 余额卡片显示全部子账户) + vibe-trading @v0.1.12"
