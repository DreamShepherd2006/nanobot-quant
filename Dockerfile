...
RUN echo "[bust=53]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@36d966a \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @36d966a (CD fork feat/execution-loop — P1 loop execution mode, bust=53) + vibe-trading @v0.1.12"
