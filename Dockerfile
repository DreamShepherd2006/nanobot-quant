...
RUN echo "[bust=95]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@5fced63 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @5fced63 (upstream main — PR #133 数据源注册表+回测异步化+stdout 根治, bust=95) + vibe-trading @v0.1.12"
