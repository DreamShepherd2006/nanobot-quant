...
RUN echo "[bust=145]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@a9eeaf6 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @a9eeaf6 (upstream main — PR #215 周期下拉动态化 Step3, bust=145) + vibe-trading @v0.1.12"
