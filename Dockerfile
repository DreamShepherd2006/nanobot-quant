...
RUN echo "[bust=53]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@1502d0f \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @1502d0f (CD fork feat/execution-loop — P1 loop execution mode, bust=53) + vibe-trading @v0.1.12"
