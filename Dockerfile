...
RUN echo "[bust=92]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@a31b497 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @a31b497 (CD fork feat/cex-p2 — CEX P1+P2+fixes, bust=92) + vibe-trading @v0.1.12"
