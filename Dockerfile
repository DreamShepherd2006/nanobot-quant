...
RUN echo "[bust=115]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@c84837b \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @c84837b (upstream main — PR #166 CEX 成交价回填 + SELL floor, bust=115) + vibe-trading @v0.1.12"
