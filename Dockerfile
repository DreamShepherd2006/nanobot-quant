...
RUN echo "[bust=91]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@fdd6bce \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @fdd6bce (CD fork feat/cex-p2 — CEX P1+P2+fixes, bust=91) + vibe-trading @v0.1.12"
