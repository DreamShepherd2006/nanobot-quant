...
# ⚠️ CD fork 验证 pin: feat/cex-channel (CEX execution channel P1) — merge 后切回上游
RUN echo "[bust=85]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherdCD/nanobot-quant.git@e10bb00 \
