...
RUN echo "[bust=41]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@ab26a8b \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @ab26a8b (upstream main — PR #65 UTC 列 + #66 TDST 突破仅展示) + vibe-trading @v0.1.12"
