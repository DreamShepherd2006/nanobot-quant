...
RUN echo "[bust=276]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@78b6c12 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @78b6c12 (upstream main — PR #270 交易记录跳过 SKIP 洪峰) + vibe-trading @v0.1.12"
