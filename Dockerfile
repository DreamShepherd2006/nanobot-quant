...
RUN echo "[bust=197]" && pip install --break-system-packages \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@7faa460 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @7faa460 (upstream main — PR #239 持仓导入/显示阈值参数化 + 卖出释放 B 方案, bust=197) + vibe-trading @v0.1.12"
