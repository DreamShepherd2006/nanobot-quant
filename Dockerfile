...
RUN echo "[bust=454]" && pip install --break-system-packages \
        'mcp<2' \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@cdb94d8 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @dbbd556 (upstream main — PR #321 covered call 执行+分派+页面闭环; bust=454) + vibe-trading @v0.1.12"
