...
RUN echo "[bust=444]" && pip install --break-system-packages \
        'mcp<2' \
        git+https://github.com/DreamShepherd2006/nanobot-quant.git@dbbd556 \
        git+https://github.com/DreamShepherd2006/Vibe-Trading.git@v0.1.12 \
    && echo "✅ nanobot-quant @dbbd556 (upstream main — PR #318 settled_itm 补买状态闭环; bust=444) + vibe-trading @v0.1.12"
